...
In the early 2010s, neural networks that specialized in creating word embeddings (e.g.\ word2vec) were successfully used to in various \gls{nlp}-Tasks.

% TODO: feature learning, representation learning

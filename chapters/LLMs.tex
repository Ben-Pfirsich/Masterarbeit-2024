...
This is also what the term \enquote{deep learning} refers to.
...
A typical way of visualizing a \gls{mlp} can be seen in TODO.

\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/nn}
    \caption[Visualization of a neural network.]{~\autocite{sonnet2022NeuralBoook}.}
    \label{fig:neural-network}
\end{figure}
% \enquote{feedforward} because information flows only in one direction


%very successfull in speech recognition, image recognition, image segmentation, optical character recognition

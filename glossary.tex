...
% Downstream Task, NLP, embedding?, fine-tuning, NLP-Task
...
\newacronym[plural=PLMs,longplural={Pre-trained Language Models}]{plm}{PLM}{Pre-trained Language Model}
\newacronym[plural=DNNs,longplural={Deep Neural Networks}]{dnn}{DNN}{Deep Neural Network}
\newacronym[plural=ANNs,longplural={Artificial Neural Networks}]{ann}{ANN}{Artificial Neural Network}
